...
export const AUTH_MESSAGES = {
  ...
  genericError: "Akci se nyní nepodařilo dokončit. Zkuste to prosím znovu.",
  registerFailed: "Registraci se nyní nepodařilo dokončit. Zkuste to prosím znovu.",
  emailTaken: "Účet s tímto e-mailem už existuje.",
  consentRequired:
    "Pro vytvoření účtu je nutné souhlasit s obchodními podmínkami a ochranou osobních údajů.",
