...
export function mapPrismaPropertyToRecord(
  ...
  return {
    ...
    acceptsCoPurchaseSeekPartner: row.acceptsCoPurchaseSeekPartner,
    acceptsCoPurchaseSellerRetains: row.acceptsCoPurchaseSellerRetains,
    offeredOwnershipPercent: row.offeredOwnershipPercent,
